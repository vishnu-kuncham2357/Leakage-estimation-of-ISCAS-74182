...
for i in range(16):
    ...
    if(count == 4):
        ...
        if(input == 0):
            # print(i_matrix)
            sum = abs(abs(i_matrix[2][0] + i_matrix[3][0] + i_matrix[1][1] - i_matrix[1][3]) + i_matrix[0][1] - i_matrix[0][3])
            sum_original = 2.84002e-09 
        elif(input == 1):
            # print(i_matrix)
            sum = abs(i_matrix[1][2] + i_matrix[0][1] - i_matrix[0][3])   + i_matrix[1][1]  + i_matrix[3][1]
            ...
            sum = isupply + i_matrix[0][1]  + i_matrix[1][1]  + i_matrix[2][1]+ i_matrix[3][1]
